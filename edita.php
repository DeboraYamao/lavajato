...
<html lang="pt-br">
    ...
    <body>
                        ...
                        <div class="card mb-2 rounded-2 shadow-sm">
                            ...
                            <form action="editar.php?id=<?php echo $id; ?>" method="POST">
                                <div class="form-group col-7">
                                    ...
                                    <br/>
                                    <button type="submit" class="btn btn-outline-success">Atualizar Cliente</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-outline-primary" href="loja.php" role="button">Voltar</a>
                                </form>
                                </div>
                            </div>
                        </div>
        ...
        <footer>
            <hr/>
            <center><b>Acesso a Banco de Dados - Desenvolvida pela Débora Yamao - TDS06 2021</b></center>
        </footer>
    </body>
</html>